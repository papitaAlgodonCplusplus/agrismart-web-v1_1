...
namespace AgriSmart.API.Agronomic.Controllers
{
    ...
    public class WaterChemistryController : ControllerBase
    {
        ...
        /// <summary>
        /// Delete a water chemistry (soft delete)
        /// </summary>
        /// <param name="Id">Water chemistry ID to delete</param>
        /// <returns></returns>
        [HttpDelete("{Id:int}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<Response<DeleteWaterChemistryResponse>>> Delete([FromRoute] int Id)
        {
            var command = new DeleteWaterChemistryCommand { Id = Id };
            var response = await _mediator.Send(command);
