...
builder.Services.AddScoped<IDeviceRawDataHourQueryRepository, DeviceRawDataHourQueryRepository>();
builder.Services.AddScoped<IDeviceRawDataMinuteQueryRepository, DeviceRawDataMinuteQueryRepository>();
