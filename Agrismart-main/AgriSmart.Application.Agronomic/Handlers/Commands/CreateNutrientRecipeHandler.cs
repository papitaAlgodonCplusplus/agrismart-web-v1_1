        ...
        public async Task<Response<CreateNutrientRecipeResponse>> Handle(CreateNutrientRecipeCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var recipe = new NutrientFormulationRecipe
                {
                    ...
                    Notes = request.Notes,
                    SoilAnalysisId = request.SoilAnalysisId,
                    FormulationMode = request.FormulationMode,
                    FertigationVolumePerApplication = request.FertigationVolumePerApplication,
                    FertigationApplicationsPerWeek = request.FertigationApplicationsPerWeek,
                    FertigationLeachingFraction = request.FertigationLeachingFraction,
                    FertigationRootDepth = request.FertigationRootDepth,
                    PercentageNitrogen = request.PercentageNitrogen,
                    PercentagePhosphorus = request.PercentagePhosphorus,
                    PercentagePotassium = request.PercentagePotassium,
                    PercentageCalcium = request.PercentageCalcium,
                    PercentageMagnesium = request.PercentageMagnesium,
                    StatusMessage = request.StatusMessage,
                    SummaryLine = request.SummaryLine,

                    // Advanced Calculator Fields
                    OptimizationMethod = request.OptimizationMethod,
                    OptimizationStatus = request.OptimizationStatus,
                    TotalDosageGramsPerLiter = request.TotalDosageGramsPerLiter,
                    SolverTimeSeconds = request.SolverTimeSeconds,
                    IonicBalanceError = request.IonicBalanceError,
                    AverageDeviationPercent = request.AverageDeviationPercent,
                    SuccessRatePercent = request.SuccessRatePercent,
                    CalculationResultsJson = request.CalculationResultsJson,

                    // Advanced Calculation Data JSON
                    CalculationDataUsedJson = request.CalculationDataUsedJson,
                    IntegrationMetadataJson = request.IntegrationMetadataJson,
                    OptimizationSummaryJson = request.OptimizationSummaryJson,
                    PerformanceMetricsJson = request.PerformanceMetricsJson,
                    CostAnalysisJson = request.CostAnalysisJson,
                    NutrientDiagnosticsJson = request.NutrientDiagnosticsJson,
                    LinearProgrammingAnalysisJson = request.LinearProgrammingAnalysisJson,
                    DataSourcesJson = request.DataSourcesJson,
                    FertilizerDosagesJson = request.FertilizerDosagesJson,
                    VerificationResultsJson = request.VerificationResultsJson,

                    // Quick Access Fields
                    LinearProgrammingEnabled = request.LinearProgrammingEnabled,
                    ActiveFertilizerCount = request.ActiveFertilizerCount,
                    CalculationTimestamp = request.CalculationTimestamp,
                    CatalogIdUsed = request.CatalogIdUsed,
                    PhaseIdUsed = request.PhaseIdUsed,
                    WaterIdUsed = request.WaterIdUsed,
                    UserIdUsed = request.UserIdUsed,
                    ApiPriceCoveragePercent = request.ApiPriceCoveragePercent,
                    CostPerM3Crc = request.CostPerM3Crc,
                    FertilizersAnalyzed = request.FertilizersAnalyzed,
                    SafetyCapsApplied = request.SafetyCapsApplied,
                    StrictCapsMode = request.StrictCapsMode,

                    // Additional Nutrients
                    TargetChloride = request.TargetChloride,
                    AchievedChloride = request.AchievedChloride,
                    TargetSodium = request.TargetSodium,
                    AchievedSodium = request.AchievedSodium,
                    TargetAmmonium = request.TargetAmmonium,
                    AchievedAmmonium = request.AchievedAmmonium,
                    TargetManganese = request.TargetManganese,
                    AchievedManganese = request.AchievedManganese,
                    TargetZinc = request.TargetZinc,
                    AchievedZinc = request.AchievedZinc,
                    TargetCopper = request.TargetCopper,
                    AchievedCopper = request.AchievedCopper,
                    TargetBoron = request.TargetBoron,
                    AchievedBoron = request.AchievedBoron,
                    TargetMolybdenum = request.TargetMolybdenum,
                    AchievedMolybdenum = request.AchievedMolybdenum,

                    // PDF Report
                    PdfReportFilename = request.PdfReportFilename,
                    PdfReportGenerated = request.PdfReportGenerated,
