            ...
            try
            {
                return await (from gm in _context.GrowingMedium
                              ...
                              select new GrowingMedium
                              {
                                  ...
                                  Name = gm.Name,
                                  SaturationPoint = gm.SaturationPoint,
                                  ContainerCapacityPercentage = gm.ContainerCapacityPercentage,
                                  PermanentWiltingPoint = gm.PermanentWiltingPoint,
                                  FiveKpaHumidity = gm.FiveKpaHumidity,
                                  EaselyAvailableWaterPercentage = gm.EaselyAvailableWaterPercentage,
                                  ReserveWaterPercentage = gm.ReserveWaterPercentage,
                                  TotalAvailableWaterPercentage = gm.TotalAvailableWaterPercentage,
