            ...
            try
            {
                return await (from f in _context.Farm
                              ...
                              select new Farm
                              {
                                  ...
                                  Location = fg.FirstOrDefault().Location,
                                  Address = fg.FirstOrDefault().Address,
                                  Area = fg.FirstOrDefault().Area,
                                  Latitude = fg.FirstOrDefault().Latitude,
                                  Longitude = fg.FirstOrDefault().Longitude,
                                  Climate = fg.FirstOrDefault().Climate,
                                  SoilType = fg.FirstOrDefault().SoilType,
