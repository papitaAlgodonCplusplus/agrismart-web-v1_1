...
export class IrrigationEngineeringService {
  ...
  private generateMockHydraulicResults(): HydraulicParameters {
    return {
      totalPressureLoss: 2.5,
      mainLinePressureLoss: 1.2,
      secondaryLinePressureLoss: 0.8,
      lateralLinePressureLoss: 0.5,
      minorLosses: 0.3,
      systemFlowRate: 125.5,
      designFlowRate: 120.0,
      peakFlowRate: 135.0,
      averageVelocity: 1.8,
      reynoldsNumber: 85000,
      distributionUniformity: 92.5,
      applicationEfficiency: 88.3,
